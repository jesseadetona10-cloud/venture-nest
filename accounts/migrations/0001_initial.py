    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('manager', 'Venture Manager'), ('founder', 'Founder'), ('team_member', 'Team Member'), ('investor', 'Investor')], max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='email_cooldown', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
